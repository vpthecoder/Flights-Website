...
$departure_date2 = $_GET["departure-date2"];
$arrival_date2 = $_GET["arrival-date2"];
...
$sql4 = "SELECT * from flight where origin like '%$origin2%' and destination like '%$destination2%' and departure_date
like '%$departure_date2%' and arrival_date like '%$arrival_date2%'";

$result = $conn2 -> query($sql3);

$result2 = $conn2 -> query($sql4);
  ...
  while($row = $result->fetch_assoc()) {
    ...
    "</td> <td>" .$row["price"]. "</td> <td> <input type='checkbox'/> </td></tr> ";
  }
  echo "</table>";
  echo "<table style=border:'1'> <tr> <th> ID </th> <th> Origin </th> <th> Destination </th> <th> Departure Date </th> <th> Departure time </th> <th> Arrival Date </th> <th> Arrival Time </th>
        <th> Price </th> <th> Select a Flight </th> </tr> "; 
  ...
  echo "</table>";
  $sql5 = "SELECT id, origin, destination, departure_date, departure_time, arrival_date, arrival_time, price from flight where origin like '%$origin2%' and destination like '%$destination2%'";
 ...
 $(document).ready(function() {
  ...
  $('input[type="checkbox"]').click(function() {
    ...
    $('#submit').click(function(){
        var txtstring='<br/>  <p> Flight Details: </p>   <p>';
        var countNumber = 0;
        for (var i = 0; i < count.length/9; i++)
        {
          for (var k = 0; k < 9; k++)
          {
            txtstring += count[countNumber] + ",";
            countNumber++;
          }
          txtstring += '<br/>';
        }
        ...
        var newString = '<br/> <p> Total Price: </p>  <p> ' + newNumber + '</p>';
        ...
        var form = '<form action="booking.php"> <label for="passengerid">Enter your Passenger ID </label> <input type="text" id="passengerid" name="passengerid"/> <br/>' +
                '<label for="flightid">Enter your flight ID(one flight at a time) </label> <input type="text" id="flightid" name="flightid"/> <br/>' +
